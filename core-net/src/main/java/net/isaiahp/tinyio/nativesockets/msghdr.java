...
public class msghdr {
    ...
    public static MemorySegment msg_name$get(MemorySegment seg) {
        return (MemorySegment)constants$0.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment msg_name$get(MemorySegment seg, long index) {
        return (MemorySegment)constants$0.const$3.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemorySegment msg_iov$get(MemorySegment seg) {
        return (MemorySegment)constants$0.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment msg_iov$get(MemorySegment seg, long index) {
        return (MemorySegment)constants$0.const$5.get(seg.asSlice(index*sizeof()));
    }
